...
import org.apache.commons.fileupload.servlet.ServletFileUpload;  
 public class CKEditorUploadServlet extends HttpServlet {  
	...
	public static void setBaseDir(String baseDir) {
		CKEditorUploadServlet.baseDir = baseDir;
	}
	public static boolean isDebug() {
		return debug;
	}
	public static void setDebug(boolean debug) {
		CKEditorUploadServlet.debug = debug;
	}
	public static boolean isEnabled() {
		return enabled;
	}
	public static void setEnabled(boolean enabled) {
		CKEditorUploadServlet.enabled = enabled;
	}
	public static Hashtable getAllowedExtensions() {
		return allowedExtensions;
	}
	public static void setAllowedExtensions(Hashtable allowedExtensions) {
		CKEditorUploadServlet.allowedExtensions = allowedExtensions;
	}
	public static Hashtable getDeniedExtensions() {
		return deniedExtensions;
	}
	public static void setDeniedExtensions(Hashtable deniedExtensions) {
		CKEditorUploadServlet.deniedExtensions = deniedExtensions;
	}
	public static SimpleDateFormat getDirFormatter() {
		return dirFormatter;
	}
	public static void setDirFormatter(SimpleDateFormat dirFormatter) {
		CKEditorUploadServlet.dirFormatter = dirFormatter;
	}
	public static SimpleDateFormat getFileFormatter() {
		return fileFormatter;
	}
	public static void setFileFormatter(SimpleDateFormat fileFormatter) {
		CKEditorUploadServlet.fileFormatter = fileFormatter;
	}  
 }  